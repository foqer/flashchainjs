...
describe("ChainStore", () => {
    ...
    before(function() {
        /* use wss://flashchain.flashchain.org/ws if no local node is available */
        return Apis.instance("wss://flashchain.flashchain.org/ws", true).init_promise.then(function() {
        });
    });
    ...
    it("Transfer", () => {
        ...
        assert.doesNotThrow(function() {
            tr.add_type_operation( "transfer", {
                ...
                memo: {
                    from: "FLC1111111111111111111111111111111114T1Anm",
                    to: "FLC1111111111111111111111111111111114T1Anm",
                    nonce: 0,
                    message: ""
                }
            });
