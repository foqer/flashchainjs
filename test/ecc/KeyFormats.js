...
var test = function(key) {
    describe("KeyFormats", function() {
        ...
        describe("Key Formats", function() {
            ...
            it("Create FLC short address", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.flc_address, public_key.toAddressString());
            })
            ...
            it("FLC public key import / export", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.public_key, public_key.toPublicKeyString());
            });
...
test({
    // delegate0
    // sourced from: ./flashchain/programs/utils/flc_create_key
    public_key: "FLC7jDPoMwyjVH5obFmqzFNp4Ffp7G2nvC7FKFkrMBpo7Sy4uq5Mj",
    ...
    flc_address: "FLC8DvGQqzbgCR5FHiNsFf8kotEXr8VKD3mR",
    ...
    // https://github.com/FlashChain/flashchain/blob/2602504998dcd63788e106260895769697f62b07/libraries/wallet/wallet_db.cpp#L103-L108
    Uncompressed_BTC:	"FLCLAFmEtM8as1mbmjVcj5dphLdPguXquimn",
    Compressed_BTC:	"FLCANNTSEaUviJgWLzJBersPmyFZBY4jJETY",
    Uncompressed_PTS:	"FLCEgj7RM6FBwSoccGaESJLC3Mi18785bM3T",
    Compressed_PTS:	"FLCD5rYtofD6D4UHJH6mo953P5wpBfMhdMEi",
    null_public_key: "FLC1111111111111111111111111111111114T1Anm"
});
