# FlashchainJS (flashchainjs)

Pure JavaScript Flashchain library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.
...
[![npm version](https://img.shields.io/npm/v/flashchainjs.svg?style=flat-square)](https://www.npmjs.com/package/flashchainjs)
[![npm downloads](https://img.shields.io/npm/dm/flashchainjs.svg?style=flat-square)](https://www.npmjs.com/package/flashchainjs)
...
{
    active: [
        ["FLC5Abm5dCdy3hJ1C5ckXkqUH2Me7dXqi9Y7yjn9ACaiSJ9h8r8mL", 1]
    ]
}
```
...
var {ChainStore} = require("flashchainjs");
...
```
var {PrivateKey, key} = require("flashchainjs");
